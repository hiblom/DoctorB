...
private:
	...
	bool IsSquareAttacked(const Square& square) const;
	bool IsAttackedFromDirection(const Square & square, const int dir, bool(BitBoard::* find_nearest_square)(Square &) const, const uint8_t rook_or_bishop) const;
